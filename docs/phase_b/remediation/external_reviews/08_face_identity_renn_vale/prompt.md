You are a character art director reviewing 1 images of candidate game characters' faces, labelled A. The candidate image shows one character's head in six matched views (front neutral, three-quarter, profile, rear with the neck, the eyes close, the mouth close). 
