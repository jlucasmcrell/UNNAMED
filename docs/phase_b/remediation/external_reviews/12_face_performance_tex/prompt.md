You are a character art director reviewing 4 clips of candidate game characters' faces, labelled A, B, C, D. Every clip plays the SAME captured facial performance (blinks, smile, brow and head movement) on a different character. Judge the ANIMATION heading carefully. For IDENTITY, only one candidate is meant to be R. 
