You are a character art director reviewing 4 clips of candidate game characters' faces, labelled A, B, C, D. Each candidate clip is 8 seconds of the same facial performance: blinks, eye movements left and right, a speech-shape sequence, a smile, concern, raised brows and a head turn. 
