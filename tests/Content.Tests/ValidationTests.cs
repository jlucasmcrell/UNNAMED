    ...
    public void LoadAll_Loads_Yaml_Files()
    {
        ...
        Assert.Equal(
            new[]
            {
                ...
                "config.base_speeds", "config.creature_behaviour", "config.damage_constants", "config.economy", "config.inventory", "config.level_cap", "config.progression",
                ...
                "effect.bleeding", "effect.mending", "effect.venom", "effect.weakened",
                ...
                "loot.animated_armour", "loot.bristleback_boar", "loot.den_cache", "loot.wolf_grey", "merchant.smith_orren", "region.ashen_hollow",
