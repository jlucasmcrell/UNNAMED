    ...
    public void LoadAll_Loads_Yaml_Files()
    {
        ...
        Assert.Equal(
            new[]
            {
                ...
                "config.base_speeds", "config.building", "config.companion", "config.crafting", "config.creature_behaviour", "config.damage_constants", "config.economy", "config.factions", "config.inventory",
                "config.level_cap", "config.magic", "config.navigation", "config.progression", "config.simulation_tiers", "config.time", "config.xp_curve",
                ...
                "faction.ashen_hollow.survey", "faction.ashen_hollow.waystation",
                ...
                "loot.animated_armour", "loot.bristleback_boar", "loot.den_cache", "loot.merchant_cart", "loot.timber_stack", "loot.waystation_chest", "loot.wolf_grey",
                ...
                "piece.door.timber", "piece.doorway.timber", "piece.pad.timber", "piece.roof.timber", "piece.station.anvil", "piece.storage.chest", "piece.wall.timber",
