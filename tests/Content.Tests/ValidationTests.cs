    ...
    public void LoadAll_Loads_Yaml_Files()
    {
        ...
        Assert.Equal(
            new[]
            {
                ...
                "config.base_speeds", "config.creature_behaviour", "config.damage_constants", "config.economy", "config.inventory", "config.level_cap", "config.magic",
                "config.progression", "config.simulation_tiers", "config.time", "config.xp_curve",
                ...
                "loot.animated_armour", "loot.bristleback_boar", "loot.den_cache", "loot.longhouse_shelf", "loot.wolf_grey", "merchant.smith_orren",
                "region.ashen_hollow",
                "skill.athletics", "skill.force", "skill.one_hand_blade", "skill.survival", "skill.vital", "skill.warding",
