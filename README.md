...
## Exploration is driven by knowledge and curiosity
...
## Dangerous places remain dangerous
...
## Seamless first- and third-person play
...
## Combat is physical before it is numerical
...
## Stealth is perception, not global aggro
...
## Crafting is construction, not a closed recipe list
...
## Magic uses Resonance and Strain
...
## Gods exist — explanation remains open
...
2. implement the smallest coherent feature set;
3. build;
4. run automated tests;
5. perform runtime validation where appropriate;
6. fix regressions;
7. update documentation;
8. provide evidence against exit criteria.
